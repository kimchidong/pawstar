...
def seed_database():
    ...
    try:
        ...
        # 2. Contests (1월~12월 각 월별 테마 콘테스트명과 40자 이내 멘트)
        contests_data = [
            (1, '제1회 새해 맞이 펫스타 콘테스트', '새해 복 많이 받아라냥! 2026년 첫 펫 스타에 도전하세요 🌅', '2026-01-01 00:00:00', '2026-01-31 23:59:59', 'CLOSED', ''),
            (2, '제2회 발렌타인 심쿵 콘테스트', '사르르 녹아내리는 우리 아이의 달콤한 심쿵 모먼트 🍫❤️', '2026-02-01 00:00:00', '2026-02-28 23:59:59', 'CLOSED', ''),
            (3, '제3회 봄맞이 설렘 펫 콘테스트', '살랑살랑 봄바람 타고 찾아온 미소 천사 펫 스타 🌸🐝', '2026-03-01 00:00:00', '2026-03-31 23:59:59', 'CLOSED', ''),
            (4, '제4회 벚꽃 피크닉 펫 챔피언십', '벚꽃 길 따라 화사하게 터지는 댕냥이 피크닉 자랑 🌸🐕', '2026-04-01 00:00:00', '2026-04-30 23:59:59', 'CLOSED', ''),
            (5, '제5회 가정의 달 펫 패밀리 콘테스트', '우리 집 보물 1호! 세상에서 가장 따뜻한 펫 가족의 순간 🏡💖', '2026-05-01 00:00:00', '2026-05-31 23:59:59', 'CLOSED', ''),
            (6, '제6회 청량 힐링 펫 콘테스트', '초여름 싱그러움 가득! 보기만 해도 힐링되는 펫 스타 🌿🌊', '2026-06-01 00:00:00', '2026-06-30 23:59:59', 'CLOSED', ''),
            (7, '제7회 썸머 파라다이스 펫 콘테스트', '무더위를 싹 씻어줄 시원하고 러블리한 썸머 펫 스타 🌊🍦', '2026-07-01 00:00:00', '2026-07-31 23:59:59', 'IN_PROGRESS', ''),
            ...
            (12, '제12회 홀리데이 크리스마스 펫 챔피언십', '메리 크리스마스! 산타 옷 입은 가장 사랑스러운 선물 🎄🎁', '2026-12-01 00:00:00', '2026-12-31 23:59:59', 'SCHEDULED', '')
        ]
